...
var SaveContainer_style = __webpack_require__(11);
...
var SaveContainer_SaveContainer =
/*#__PURE__*/
function (_Component) {
  ...
  function SaveContainer(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SaveContainer).call(this, props));
  }
...
var InitDragDrop_style = __webpack_require__(12);
...
function InitDragDrop_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { InitDragDrop_typeof = function _typeof(obj) { return typeof obj; }; } else { InitDragDrop_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return InitDragDrop_typeof(obj); }
...
function (_Component) {
  ...
  function App(props) {
    ...
    _this = InitDragDrop_possibleConstructorReturn(this, InitDragDrop_getPrototypeOf(App).call(this, props)); //console.log(this.props) //props will get logged.
    //init data

    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "saveData", function () {
      var allNewResults = react_dom_default.a.findDOMNode(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this))).innerHTML.match(/<div\s*class=\"app-section\"(.*?)>(.*?)<\/div>/gim);
    ...
    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "handleDrag", function (e, todo) {
      e.preventDefault();
    ...
    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "handleClick", function (e, todo) {
      e.preventDefault();

      _this.setState({
        newCompletedTasks: _toConsumableArray(_this.state.completedTasks).concat([todo]),
        completedTasks: _toConsumableArray(_this.state.completedTasks).concat([todo])
      }); //Output the latest results to the form to save the data.


      var result = components_SaveController(_toConsumableArray(_this.state.completedTasks).concat([todo]), 'app-alldata');
    });

    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "handleDragOver", function (e) {
      e.preventDefault();
    });

    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "handleDrop", function (e) {
      ...
      if (true === classie_default.a.has(e.target, 'app__dones')) {
        ...
        if (true === draggedTask.hasOwnProperty('taskID')) {
          _this.setState({
            completedTasks: _toConsumableArray(completedTasks).concat([draggedTask]),
    ...
    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "handleDragEnd", function (e) {
      //save data
      _this.saveData();
    });

    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "handleHoverOIn", function (e, id, type) {
    ...
    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "handleHoverOut", function (e, id, type) {
      var subprefix = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
    ...
    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "HTMLDecode", function (children) {
    ...
    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "divEditable", function (e) {
      var html = react_dom_default.a.findDOMNode(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this))).innerHTML;
    ...
    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "getTodos", function () {
    ...
    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "handleSortableOnDragStart", function (i) {
      _this.setState({
        dragging: i,
    ...
    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "handleSortableOnDragEnd", function () {
      _this.setState({
        overIndex: null
      });
    });

    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "handleSortableOnDragOver", function (i) {
    ...
    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "navHandleClick", function (e) {
      e.preventDefault();
      e.stopPropagation();
    ...
    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "hasClass", function (elem, className) {
      return new RegExp(' ' + className + ' ').test(' ' + elem.className + ' ');
    });

    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "toggleClass", function (elem, className) {
    ...
    _defineProperty(InitDragDrop_assertThisInitialized(InitDragDrop_assertThisInitialized(_this)), "componentDidUpdate", function (prevProps, prevState) {});
      ...
      return react_default.a.createElement(react_default.a.Fragment, null, react_default.a.createElement("div", {
            ...
            for (var i = 0; i < todos.length; i++) {
              ...
              if (InitDragDrop_typeof(todos[i].content) != ( true ? "undefined" : undefined)) {
                ...
                if (submenus.length > 0) {
                  displaySubEl = react_default.a.createElement('ul', {
              ...
              displayEl.push(react_default.a.createElement("li", {
                key: i,
                onClick: function onClick(event) {
        ...
        var _loop = function _loop(i) {
          ...
          if (InitDragDrop_typeof(task.taskID) != ( true ? "undefined" : undefined)) {
            displayEl2.push(react_default.a.createElement("div", {
              id: "app__done-" + i,
              key: i,
              "data-id": task.taskID,
        ...
        return displayEl2;
      }())), react_default.a.createElement(components_SaveContainer, {
        id: "app-alldata"
      }));
    }
  }]);
...
react_dom_default.a.render(react_default.a.createElement(InitDragDrop, null), document.getElementById('app'));
